...
const cardapio = [
  new Prato("Feijoada", 15.00, "Prato Principal"),
  new Prato("Coxinha", 9.00, "Petisco"),
  new Prato("Brigadeiro", 10.00, "Sobremesa"),
]
...
// LIVE CODE - substitua a string vazia pelas classes bootstrap
  card.className = 'card-prato col-12 col-md-6 col-lg-4 p-4 bg-white text-white text-center rounded-3 shadow-sm'
